  ...
  return (
    <div style={{ display: 'flex', gap: 8 }}>
      <button
        ...
        style={{ backgroundColor: '#0066cc', color: 'white', border: 'none', padding: '8px 14px', borderRadius: 4, cursor: 'pointer' }}
      ...
      <button
        style={{ backgroundColor: '#6c757d', color: 'white', border: 'none', padding: '8px 14px', borderRadius: 4, cursor: 'pointer' }}
